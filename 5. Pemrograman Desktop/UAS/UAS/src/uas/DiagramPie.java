 ...
 */
class DiagramPie extends JFrame{
    public void setNilai(String namatable) throws SQLException {
    ...
    private PieDataset buildData(String namatable) throws SQLException {
        ...
        try {
            ...
            while (r.next())    {
                ...
                String JudulBuku = r.getString("JudulBuku");
                String StokBuku = r.getString("StokBuku");
                dataSet.setValue(JudulBuku, Integer.parseInt(StokBuku));
            }
            r.close();
            s.close();
